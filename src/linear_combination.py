...
class Logger:
    def __init__(self, initial_data):
        ...
        ['date', 'stocks', 'budget', 'bought_stocks', 'cost', 'total_cost', 'budget_after_trans', 'stocks_after_trans']
                                 )
    ...
    def logValue(self, index, value):
        ...
        if (value.get('date') == 'final-transaction'):
            ...
            self.logs.loc[index, 'bought_stocks'] = self.logs.loc[index]['bought_stocks'] + value['bought_stocks']
